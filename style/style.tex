...
% ============
% This emulates titelsec commands using Koma-Scrips
...
\usepackage[backend=bibtex,bibencoding=ascii,style=numeric-comp,natbib=true]{biblatex}
...
\newcommand{\STYLEfootnotetext}
{
  \begin{minipage}
  {.2\textwidth}
    \includegraphics[width=0.9\textwidth]{snet/snet_footer.png}
  \end{minipage}
}
...
\newcommand{\vuln}[1]{\textit{\textcolor{DarkRed}{V#1}}}
